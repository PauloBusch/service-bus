...
namespace EmitterServiceBus.HostedServices
{
    public class ProductTopicConsumer1 : IHostedService
    {
        ...
        public ProductTopicConsumer1(IConfiguration configuration)
        {
            _subscriptionClient = new SubscriptionClient(configuration.GetConnectionString("AzureServiceBus"), "store", "store-sub1");
        }
